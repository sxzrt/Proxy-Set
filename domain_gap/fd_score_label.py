...
def calculate_activation_statistics(size, target_model, data, lbls, model, batch_size=50,
...
def load_and_make_list(target_path):
    mode = "test"
...
def calculate_fd_label_given_paths(paths, target_model, size, checkpoint_path = None):
